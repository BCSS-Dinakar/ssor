  ...
  return (
    <div className="space-y-6 pb-8 animate-fadeIn">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        <Card className="flex h-[500px] flex-col overflow-hidden xl:col-span-2">
        ...
        <Card className="flex h-[500px] flex-col overflow-hidden xl:col-span-1">
          <CardHeader className="flex flex-row items-center justify-between shrink-0">
            <div>
          ...
          <div className="flex-1 overflow-auto">
            <table className="w-full text-left text-sm">
              <tbody className="divide-y divide-slate-100">
                {data.recentActivity && data.recentActivity.map((a, i) => (
                  <tr key={i} className="hover:bg-slate-50/80">
                    <td className="px-6 py-3 text-slate-700">
                      <div className="font-medium text-slate-800">{a.action}</div>
                      <div className="mt-1 font-mono text-xs text-muted">{a.time}</div>
                    </td>
                  </tr>
                ))}
                {(!data.recentActivity || data.recentActivity.length === 0) && (
                  <tr>
                    <td className="px-6 py-12 text-center text-muted">
