      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8">
            <h3 className="font-extrabold text-primary font-heading text-sm uppercase tracking-wider mb-4 pb-3 border-b border-slate-100 flex items-center gap-2">
          ...
          {(record.status === 'pending' || record.status === 'verifying') ? (
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <h3 className="font-extrabold text-primary font-heading text-sm uppercase tracking-wider">
                  Criminal History Check
                </h3>
                {checkState === 'idle' && (
                  <button
                    onClick={startCriminalCheck}
                    className="btn-primary text-sm py-2 px-4 shadow-md uppercase tracking-wider"
                  >
              ...
              {checkState === 'running' && (
                <div className="relative bg-slate-900 border border-slate-800 h-[140px] rounded-xl flex flex-col items-center justify-center p-4 text-center overflow-hidden shadow-inner">
                  ...
                  <div className="relative z-10 flex items-center gap-2">
                    ...
                    <div className="text-sm font-bold text-blue-100 uppercase tracking-widest font-mono animate-pulse">
                      {activeLog}
                    </div>
                  </div>
                </div>
              ...
              {checkState === 'done' && suspects.length > 0 && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <span className="text-xs uppercase tracking-widest text-slate-400 font-black block">Database Matches for Review</span>
                    {suspects.map((sus) => {
                      const tierColors = {
                            ...
                            <div className="space-y-3 flex-grow min-w-0 w-full">
                              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                  {sus.riskTier && (
                                    <span className={`px-2.5 py-1 rounded-lg text-xs font-black uppercase tracking-widest border shadow-sm ${badgeClass}`}>
                                      {sus.riskTier} TIER
                                    </span>
                                  )}
                                  {sus.priority && (
                                    <span className="px-2.5 py-1 rounded-lg text-xs font-black uppercase tracking-widest bg-amber-50 text-amber-700 border border-amber-200 shadow-sm flex items-center gap-1">
                              ...
                              <div className="flex flex-wrap gap-2">
                                ...
                                {(sus.alias && sus.alias !== 'N/A' && sus.alias !== '—') && (
                                  <div className="flex items-center gap-1.5 text-sm text-slate-600 bg-slate-50 border border-slate-100 rounded-lg px-2 py-1 font-medium shadow-sm">
                                    <span className="text-xs font-black uppercase tracking-widest text-slate-400">ALIAS</span>
                                ...
                                {(sus.offence && sus.offence !== 'N/A' && sus.offence !== '—') && (
                                  <div className="flex items-center gap-1.5 text-sm text-slate-600 bg-slate-50 border border-slate-100 rounded-lg px-2 py-1 font-medium shadow-sm flex-grow sm:flex-grow-0">
                                    <span className="text-xs font-black uppercase tracking-widest text-slate-400 shrink-0">FIR / CRIME</span>
              ...
              {checkState === 'done' && suspects.length === 0 && (
                <div className="p-4.5 bg-emerald-50 border border-emerald-250 text-emerald-850 rounded-2xl text-sm font-bold leading-normal flex items-start gap-3.5 shadow-inner">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 space-y-6">
              ...
              {record.status === 'cleared' ? (
                <div className="p-4.5 bg-emerald-50 border border-emerald-250 text-emerald-850 rounded-2xl text-sm font-bold space-y-2 shadow-inner">
                  <div className="flex items-center gap-2 text-emerald-850 font-heading uppercase text-sm font-black">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-4">
                      <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="font-extrabold text-primary font-heading text-sm uppercase tracking-wider">
                            Matched suspect details: {record.matchedSuspect.name}
                          </h4>
                        </div>
                        <Link
                          to={`/portal/register/${record.matchedSuspect.id}`}
                          className="inline-flex items-center gap-1.5 text-xs font-black uppercase text-secondary bg-blue-50 border border-blue-200 hover:bg-blue-100 px-3 py-1.5 rounded-xl transition-all"
                        >
                        ...
                        {[
                          ...
                          return (
                            <button
                              ...
                              className={`flex items-center gap-1.5 px-3 py-2 border-b-2 font-heading font-black text-xs uppercase tracking-wider transition-all whitespace-nowrap ${
                                active
                      ...
                      <div className="min-h-[160px] pt-2">
                        {activeSuspectTab === 'profile' && (
                          <div className="space-y-4">
                            ...
                            <div className="p-3 bg-slate-50 border border-slate-150 rounded-xl">
                              <span className="text-xs uppercase tracking-widest text-slate-400 font-black block mb-1">Present Registered Address</span>
                        ...
                        {activeSuspectTab === 'physical' && (
                          <div className="space-y-4">
                            ...
                            <div className="p-3 bg-slate-50 border border-slate-150 rounded-xl">
                              <span className="text-xs uppercase tracking-widest text-slate-400 font-black block mb-1">Distinctive Moles & Marks (pf_mole)</span>
                        ...
                        {activeSuspectTab === 'case' && (
                          <div className="space-y-4">
                            ...
                            <div className="p-3 bg-slate-50 border border-slate-150 rounded-xl">
                              <span className="text-xs uppercase tracking-widest text-slate-400 font-black block mb-1">Convicted Offence Summary</span>
        ...
        <div className="space-y-6">
          <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8">
            <h3 className="font-extrabold text-primary font-heading text-sm uppercase tracking-wider mb-4 pb-3 border-b border-slate-100">Vetting Outcome</h3>
            
            <div className="mb-6">
              <div className="text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Vetting Status</div>
              <StatusPill status={record.status} />
            </div>

            {(record.status !== 'pending' && record.status !== 'verifying') ? (
              <div className="space-y-4">
                <div className="p-4 bg-slate-50 border border-slate-150 rounded-2xl text-sm text-slate-500 font-bold leading-normal">
                ...
                {record.policeFeedback && (
                  <div className="p-4 bg-slate-50 border border-slate-150 rounded-2xl space-y-1">
                    <span className="text-xs uppercase tracking-widest text-slate-455 font-black block">Decision Log Reason</span>
              ...
              <>
                {checkState === 'running' && (
                  <div className="flex items-center justify-center p-6 bg-slate-50 border border-slate-150 rounded-2xl text-sm text-slate-455 font-bold">
                ...
                {checkState === 'done' && (
                  <div className="space-y-4">
                    <div className="mb-2">
                      <label className="block text-sm font-black text-slate-400 uppercase tracking-widest mb-2">Officer Verification Notes / Feedback</label>
                      <textarea
                    ...
                    {hasHistory ? (
                      <>
                        <button
                          ...
                          className={`w-full inline-flex justify-center items-center gap-2 px-4 py-3 text-sm font-black uppercase tracking-wider text-white transition-all rounded-xl shadow-lg ${
                            confirmedSuspect
                        ...
                        <button
                          disabled={true}
                          className="w-full inline-flex justify-center items-center gap-2 px-4 py-3 text-sm font-black uppercase tracking-wider bg-slate-100 text-slate-400 border border-slate-200 transition-all rounded-xl cursor-not-allowed opacity-50"
                        >
                      ...
                      <>
                        <button
                          onClick={handleClear}
                          className="w-full inline-flex justify-center items-center gap-2 px-4 py-3 text-sm font-black uppercase tracking-wider bg-emerald-600 hover:bg-emerald-700 text-white transition-all rounded-xl shadow-lg shadow-emerald-100"
                        >
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-[90vw] md:w-[70vw] flex flex-col shadow-2xl overflow-hidden border border-slate-200 h-[85vh]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex items-center justify-between px-5 py-4 bg-gradient-to-r from-primary to-[#0f2a4a] text-white border-b border-slate-700/30">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold uppercase tracking-wider font-heading">Offender Register Match Vetting</span>
              </div>
            ...
            <div className="p-6 bg-slate-50 flex-grow overflow-y-auto space-y-6 text-sm">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-slate-200 pb-4 gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-extrabold text-primary font-heading text-base uppercase tracking-wider">{inspectSuspect.person_details?.full_name !== 'N/A' ? inspectSuspect.person_details?.full_name : inspectSuspect._listContext?.name || 'Unknown'}</h4>
                    <span className="text-sm text-slate-400 font-mono block mt-0.5">SOR Record ID: {inspectSuspect.offender_id}</span>
                  </div>
                </div>
                <div className="bg-red-50 text-red-700 border border-red-200 font-black text-xs uppercase tracking-wider px-3 py-1 rounded-full">
                  Convicted Offender
                </div>
              </div>
            ...
            <div className="p-4 bg-slate-100 border-t border-slate-200 text-right flex flex-col sm:flex-row justify-between items-center gap-3 shrink-0">
              ...
              <div className="space-x-3 flex items-center">
                <button 
                  ...
                  className="px-4 py-2 text-sm font-bold text-slate-600 hover:text-slate-900 transition-colors uppercase tracking-widest"
                >
                  Close Match
                </button>
                <button
                  ...
                  className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-xl text-sm font-black transition-colors uppercase tracking-widest shadow-lg shadow-red-200 flex items-center gap-2 inline-flex"
                >
