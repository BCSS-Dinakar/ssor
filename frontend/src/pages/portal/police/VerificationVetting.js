                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {suspects.map((sus) => {
                      ...
                      const badgeClass = tierColors[sus.riskTier] || 'bg-amber-100 text-amber-800 border-amber-300';
                        ...
                        <div key={sus.id} className="p-4 bg-slate-50 border border-slate-200 rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 hover:bg-slate-100/50 transition-colors">
                          <div className="space-y-1.5">
                            <div className="flex flex-wrap items-center gap-2">
                              <span className="font-extrabold text-slate-800 text-sm">{sus.name} <span className="text-xs text-slate-400 font-bold font-mono">({sus.id})</span></span>
                              {sus.source && (
                            ...
                            {sus.priority && (
                              <div className="text-[10px] text-amber-700 font-bold bg-amber-50 px-2 py-0.5 rounded border border-amber-200 inline-block">
                                Match Hierarchy: {sus.priority}
                              </div>
                            )}
