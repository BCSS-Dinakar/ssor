                  ...
                  {channel.items.map((item) => (
                    <li key={item.label} className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-primary font-medium mt-0.5">{item.value}</div>
                      </div>
                    </li>
                  ))}
                </ul>
                ...
                {[
                  ...
                  <div key={item.title} className="flex items-start gap-3 p-4 rounded-xl bg-slate-50 border border-slate-100">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted leading-relaxed mt-0.5">{item.text}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="card p-8 relative overflow-hidden">
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-xs text-muted italic">(This is a prototype — no message was actually sent.)</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                      <label className="text-sm font-semibold text-slate-700 tracking-wide">Full Name <span className="text-red-500">*</span></label>
                      <input
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="text-sm font-semibold text-slate-700 tracking-wide">Email <span className="text-red-500">*</span></label>
                      <input
                        type="email"
                        className={inputClass}
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                      <label className="text-sm font-semibold text-slate-700 tracking-wide">Phone</label>
                      <input
                        className={inputClass}
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="text-sm font-semibold text-slate-700 tracking-wide">Category <span className="text-red-500">*</span></label>
                      <select
                        className={inputClass}
                        value={form.category}
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-slate-700 tracking-wide">Subject <span className="text-red-500">*</span></label>
                    <input
                      className={inputClass}
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-sm font-semibold text-slate-700 tracking-wide">Message <span className="text-red-500">*</span></label>
                    <textarea
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.text} className="flex items-start gap-3">
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed pt-2">{item.text}</p>
                  </div>
                ))}
              </div>
            </div>
            <div className="relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-300 text-sm mb-4">Lakdikapul, Hyderabad, Telangana</p>
                <div className="inline-flex items-center gap-2 bg-accent/20 border border-accent/30 text-accent px-4 py-2 rounded-full text-sm font-medium">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Link key={link.title} to={link.to} className="card p-6 group hover:-translate-y-1 text-center">
                ...
                <p className="text-muted text-xs leading-relaxed">{link.text}</p>
              </Link>
            ))}
          </div>
        </div>
