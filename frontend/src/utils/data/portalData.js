...
export const NAV = {
  organization: [
    ...
    { section: 'Help' },
    { id: 'guide', label: 'User Guide', desc: 'Registry process and flows', icon: BookOpen, path: '/portal/org-guide' },
    { id: 'tiers', label: 'Risk Tier', desc: 'Section-to-tier knowledge base', icon: BookOpen, path: '/portal/tiers' },
